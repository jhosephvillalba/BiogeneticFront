...
const DetailReport = () => {
  ...
  const mockData = {
    1: {
      ...
      envase: 'Campo',
      registros: [
        { donante: '002', raza: 'Gyr', toro: 'Hancock', g1: 2, g2: 8, g3: 8, viables: 18, otros: 2, total: 20, cuv: 15, clivados: 7, clivados_percent: '47', prevision: 5, prevision_percent: '33' },
        { donante: '132', raza: 'Gyr', toro: 'Hancock', g1: 1, g2: 9, g3: 7, viables: 17, otros: 3, total: 20, cuv: 16, clivados: 10, clivados_percent: '63', prevision: 4, prevision_percent: '25' },
        { donante: '036', raza: 'Gyr', toro: 'Hancock', g1: 10, g2: 20, g3: 30, viables: 60, otros: 5, total: 65, cuv: 42, clivados: 15, clivados_percent: '36', prevision: 6, prevision_percent: '14' },
        { donante: '005', raza: 'Gyr', toro: 'Hancock', g1: 3, g2: 10, g3: 6, viables: 19, otros: 3, total: 22, cuv: 16, clivados: 9, clivados_percent: '56', prevision: 2, prevision_percent: '14' },
        { donante: '522-27', raza: 'Gyr', toro: 'Hancock', g1: 2, g2: 8, g3: 3, viables: 39, otros: 0, total: 39, cuv: 31, clivados: 20, clivados_percent: '65', prevision: 6, prevision_percent: '19' },
        { donante: '1039', raza: 'Gyr', toro: 'Hancock', g1: 2, g2: 8, g3: 10, viables: 20, otros: 3, total: 23, cuv: 17, clivados: 9, clivados_percent: '53', prevision: 6, prevision_percent: '35' },
        { donante: '1043', raza: 'Gyr', toro: 'Hancock', g1: 2, g2: 9, g3: 5, viables: 35, otros: 3, total: 38, cuv: 25, clivados: 12, clivados_percent: '48', prevision: 4, prevision_percent: '16' },
        { donante: '030', raza: 'Gyr', toro: 'Hancock', g1: 2, g2: 2, g3: 2, viables: 16, otros: 4, total: 20, cuv: 14, clivados: 10, clivados_percent: '71', prevision: 4, prevision_percent: '29' },
        { donante: '550', raza: 'Gyr', toro: 'Hancock', g1: 2, g2: 20, g3: 20, viables: 42, otros: 3, total: 45, cuv: 37, clivados: 20, clivados_percent: '54', prevision: 8, prevision_percent: '22' }
      ],
      observaciones: 'En general oocitos expandidos, con alta cantidad de detritos celulares y en el cultivo se evidencian estructuras en degeneración con núcleo sin homogeneidad'
    }
  };
  ...
  // Calcular totales
  const totales = opuData.registros.reduce((acc, curr) => ({
    g1: acc.g1 + curr.g1,
    g2: acc.g2 + curr.g2,
    g3: acc.g3 + curr.g3,
    ...
    g1: 0, g2: 0, g3: 0, viables: 0, otros: 0, total: 0, cuv: 0, clivados: 0, prevision: 0
  });
              ...
              <table className="table table-bordered table-striped">
                ...
                <tfoot className="table-light">
                  <tr>
                    ...
                    <td>{Math.round((totales.clivados / totales.total) * 100)}%</td>
                    <td>{totales.prevision}</td>
                    <td>{Math.round((totales.prevision / totales.total) * 100)}%</td>
                  </tr>
                </tfoot>
              </table>
            </div>
